        ...
        <section class="hero-wrap hero-wrap-2" style="background-image: url('images/bg_2.jpg');">
            ...
            <div class="container">
              <div class="row no-gutters slider-text align-items-center justify-content-center">
                ...
                <p class="breadcrumbs"><span class="mr-2"><a href="{{ url('/')}}">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="{{('testimonial')}}">Testimonial <i class="ion-ios-arrow-forward"></i></a></span> <span>Test_Sports <i class="ion-ios-arrow-forward"></i></span></p>
                </div>
              </div>
            </div>
          </section>
